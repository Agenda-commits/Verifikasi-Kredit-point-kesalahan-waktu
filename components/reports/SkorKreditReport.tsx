...
import { BarChart3, Star, FileText, CheckCircle2, ShieldAlert, ShieldCheck, Award, Zap, RefreshCcw } from 'lucide-react';
    ...
    <div className="flex flex-col h-full animate-in space-y-2.5 max-h-full overflow-hidden">
      ...
      <div className="border-b-[2px] border-zinc-900 pb-2 flex justify-between items-end shrink-0">
        <div>
          ...
          <p className="text-[7.5px] text-zinc-400 tracking-[0.25em] mt-1 uppercase italic font-bold">
        ...
        <div className="col-span-4 bg-[#0a0a0a] p-4 border-l-[6px] border-[#eab308] shadow-sm flex flex-col justify-center min-h-[90px] rounded-sm relative overflow-hidden">
           ...
           <div className="relative z-10">
              ...
              <div className="flex items-baseline gap-2 leading-none">
                 <p className="text-[34px] font-black text-[#eab308] tracking-tighter italic uppercase leading-none">
                    {data.skorKredit}
                 </p>
        ...
        <div className="col-span-8 bg-white border border-zinc-200 p-4 flex items-center justify-between rounded-sm shadow-sm relative overflow-hidden">
           <div className="grid grid-cols-3 gap-6">
              <div>
                 ...
                 <p className="text-[11px] font-black text-black uppercase truncate leading-tight">{data.nama}</p>
              </div>
              <div>
                 <p className="text-[6.5px] font-black text-zinc-400 uppercase tracking-widest mb-1">INSTITUSI PERBANKAN</p>
                 <p className="text-[11px] font-black text-black uppercase truncate leading-tight">{data.bank}</p>
              </div>
              <div>
                 <p className="text-[6.5px] font-black text-zinc-400 uppercase tracking-widest mb-1">NOMOR REKENING TUJUAN</p>
                 <p className="text-[11px] font-mono-tech font-bold text-black tracking-wider leading-tight">{data.noRekening}</p>
              </div>
           </div>
           <div className="flex flex-col items-end gap-0.5 opacity-10">
              <p className="text-[5.5px] font-mono text-zinc-400 uppercase">AUTH_ID</p>
              <p className="text-[6.5px] font-mono text-zinc-900 font-bold uppercase">{data.securityHash}</p>
           </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-12 gap-3 flex-1 min-h-0 overflow-hidden">
        ...
        <div className="col-span-5 bg-[#0a0a0a] text-white p-5 border-t-[4px] border-[#eab308] shadow-xl flex flex-col justify-between rounded-sm relative">
           <div className="relative z-10 flex flex-col h-full">
              <div className="flex items-center gap-2 text-[#eab308] border-b border-zinc-800/80 pb-3 mb-4 shrink-0">
                 <FileText size={11} />
              ...
              <div className="space-y-3 flex-1 overflow-hidden pr-1">
                 <div className="flex justify-between items-baseline border-b border-zinc-800/40 pb-2.5">
                    <div className="space-y-0.5">
                       ...
                       <p className="text-[8px] text-zinc-500 italic font-medium leading-none">Internal balance node validation</p>
                    </div>
                 ...
                 <div className="flex justify-between items-baseline border-b border-zinc-800/40 pb-2.5">
                    <div className="space-y-0.5">
                       ...
                       <p className="text-[8px] text-[#eab308] italic font-black leading-none uppercase tracking-tight">RATE: RP {formatClean(data.hargaPerPoint)}/PT</p>
                    </div>
                    <div className="flex items-baseline gap-1.5 shrink-0">
                       <span className="text-[9px] font-black text-zinc-600 italic">RP</span>
                 ...
                 <div className="flex justify-between items-baseline border-b border-zinc-800/40 pb-2.5">
                    <div className="space-y-0.5">
                       ...
                       <p className="text-[8px] text-zinc-500 italic font-medium leading-none">Bonus commission payout</p>
                    </div>
        ...
        <div className="col-span-7 bg-white border border-zinc-200 p-5 flex flex-col justify-between rounded-sm shadow-sm relative overflow-hidden">
           <div className="flex justify-between items-start shrink-0 mb-1">
              ...
              <div className="w-9 h-9 rounded-full bg-zinc-50 flex items-center justify-center border border-zinc-100 shadow-inner">
                 <RefreshCcw size={16} className="text-zinc-300 animate-spin-slow" />
              </div>
           </div>
           ...
           <div className="mb-3 bg-red-50/50 border border-red-200 px-4 py-2 rounded-sm flex items-start gap-3 relative overflow-hidden shadow-sm shrink-0">
              ...
              <div>
                 ...
                 <p className="text-[9.5px] font-bold text-red-900 leading-tight italic">
           ...
           <div className="bg-[#fafafa] border border-zinc-200 p-4 rounded-sm relative shadow-inner overflow-hidden border-l-[8px] border-zinc-900 flex-1 flex flex-col justify-center max-h-[170px]">
              <div className="flex items-center gap-2 mb-2.5 relative z-10 border-b border-zinc-200 pb-2 shrink-0">
                ...
                <p className="text-[9.5px] font-black text-zinc-900 tracking-[0.25em] uppercase italic leading-none">
                  PROTOKOL INTEGRITAS KREDIT POIN (STANDARD 100 PT)
                </p>
              </div>
              
              <div className="grid grid-cols-1 gap-2 relative z-10 overflow-hidden">
                 <div className="flex items-start gap-3">
                    <Award size={12} className="text-[#eab308] mt-0.5 shrink-0" />
                    <p className="text-[9px] font-bold text-zinc-500 leading-tight uppercase italic">
                 ...
                 <div className="flex items-start gap-3">
                    <Zap size={12} className="text-emerald-600 mt-0.5 shrink-0" />
                    <p className="text-[9px] font-bold text-zinc-500 leading-tight uppercase italic">
              ...
              {/* Watermark Logo */}
              <div className="absolute right-[-20px] bottom-[-20px] opacity-[0.02] pointer-events-none transform rotate-12">
                 <Award size={130} className="text-black" />
              </div>
           </div>
        </div>
      </div>
      ...
      <div className="bg-[#fffbeb] border border-[#fde047] px-6 py-2.5 shadow-sm relative border-l-[8px] border-[#fbbf24] flex items-center gap-6 shrink-0 h-[85px] rounded-r-sm overflow-hidden">
        <div className="shrink-0">
          <div className="w-9 h-9 rounded-full border border-amber-200 bg-white flex items-center justify-center shadow-sm">
             <RefreshCcw size={18} className="animate-spin-slow text-[#b45309]" />
          </div>
        </div>
        <div className="flex-1 flex flex-col overflow-hidden justify-center h-full">
          <div className="flex items-center gap-2 mb-1 shrink-0 text-[#b45309]">
            <FileText size={10} />
            <h3 className="text-[9.5px] font-black tracking-[0.2em] uppercase italic leading-none">PROTOKOL SINKRONISASI KREDIT POINT</h3>
          </div>
